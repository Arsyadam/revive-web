...
export function Footer() {
  const navigation = ["Tukar Poin", "Aplikasi", "Mitra", "CSR"];
  const legal = [{
        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              Sebuah ekosistem menejamen limbah untuk menghubungkan para
              kontributor limbah tekstil dengan UMKM serta komunitas yang
              bergerak di bidang fesyen daur ulang
            </div>
          </div>
          ...
          <div className="">
            ...
            <div className="flex mt-5 space-x-5 text-gray-400 dark:text-gray-500">
              <a
                href="https://instagram.com/revive.refashion"
                target="_blank"
                rel="noopener"
              >
              ...
              <a
                href="https://linkedin.com/in/TheNextWay"
                target="_blank"
                rel="noopener"
              >
